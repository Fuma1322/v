...
import OrderStatusBadge from "../Frontend/OrderStatusBadge";
import EditOrderModal from "../Frontend/EditOrderModal";

interface Props {
  order: Order;
}

export default function OrderDashCard({ order }: Props) {
