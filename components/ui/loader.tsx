...
export const LoaderThree = () => {
  return (
    <motion.svg
      ...
      className="h-20 w-20 stroke-neutral-500 [--fill-final:#25D366] [--fill-initial:var(--color-neutral-50)] dark:stroke-neutral-100 dark:[--fill-final:#25D366] dark:[--fill-initial:var(--color-neutral-800)]"
    >
...
export const LoaderFive = ({ text }: { text: string }) => {
  return (
    <div className="font-sans sm:text-6xl font-bold text-[#25D366] [--shadow-color:var(--color-neutral-500)] dark:[--shadow-color:var(--color-neutral-100)] flex items-center justify-center py-10">
